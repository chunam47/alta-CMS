...
import { iconMenuRight1, iconMenuRight2, iconMenuRight3 } from '../../../shared/assets/images';
            ...
            <div className="button-center__box profile-button-update">
              {!isDisableForm && (
                <>
                  ...
                  <Button
                    type="primary"
                    className="normal-button save-button"
                    htmlType="submit"
